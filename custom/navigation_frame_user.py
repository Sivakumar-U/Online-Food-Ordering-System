...
class NavigationFrameUser(ctk.CTkFrame):
    def __init__(self, master=None, user_id=None):
        ...
        self.configure(fg_color="#FFA500", height=60)
        ...
        self.create_navigation_button("home", "Home", "🏠", 0)
        self.create_navigation_button("orders", "Orders", "📋", 1)
        self.create_navigation_button("cart", "Cart", "🛒", 2)
        self.create_navigation_button("profile", "Profile", "👤", 3)
